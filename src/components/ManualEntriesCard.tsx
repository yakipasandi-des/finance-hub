...
const st: Record<string, React.CSSProperties> = {
  ...
  badge: { fontSize: 10, fontWeight: 600, color: 'var(--accent)', background: 'var(--accent-fill)', borderRadius: 4, padding: '2px 6px', whiteSpace: 'nowrap' },
  ...
  toggleActive: { background: 'var(--accent-fill)', color: 'var(--accent)', borderColor: 'var(--accent)' },
